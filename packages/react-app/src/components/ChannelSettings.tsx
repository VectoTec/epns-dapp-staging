...
function ChannelSettings() {
  ...
  const handleSendMessage = async (e) => {
    ...
    var anotherSendTxPromise = contract.sendNotification(
      nfRecipient,
      identityBytes
    );
      ...
      <Section>
        <Content padding="10px 10px">
          <Item align="flex-end">
            <ChannelActionButton
              onClick={async () => {
                ...
                const CONVERSION_URL =
                  "http://localhost:4000/apis/channels/get_dai_to_push";
                ...
                // console.log('res',res.response.data.quote.PUSH.price)

                if (res.status == 200) {
                  const pushValue = res.response.data.quote.PUSH.price;
            ...
            >
              <ActionTitle>Deactivate Channel</ActionTitle>
            </ChannelActionButton>
          </Item>
        </Content>
      </Section>
